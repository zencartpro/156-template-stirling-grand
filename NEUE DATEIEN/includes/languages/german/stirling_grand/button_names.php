...
define('BUTTON_ADD_TO_CART_ALT', 'Zum Warenkorb hinzufügen');
define('BUTTON_ADD_ADDRESS_ALT', 'Adresse hinzufügen');
define('BUTTON_ADD_PRODUCTS_TO_CART_ALT','Ausgewählte zum Warenkorb hinzufügen');
...
define('BUTTON_CONFIRM_SEND_ALT', 'Geschenkgutschein senden');
...
define('BUTTON_NEXT_ALT', 'Nächste');
define('BUTTON_PREVIOUS_ALT', 'Vorherige');
define('BUTTON_REDEEM_ALT', 'Einlösen');
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Alle');
define('BUTTON_REVIEWS_ALT', 'Bewertungen');
define('BUTTON_SEARCH_ALT', 'Suche');
define('BUTTON_SEND_ALT', 'Absenden');
define('BUTTON_SEND_ANOTHER_ALT', 'Weiteren Geschenkgutschein senden');
define('BUTTON_SEND_A_GIFT_CERT_ALT', 'Geschenkgutschein senden');
define('BUTTON_SHIPPING_ESTIMATOR_ALT', 'Versandkosten');
define('BUTTON_SOLD_OUT_ALT', 'Ausverkauft');
define('BUTTON_SOLD_OUT_SMALL_ALT', 'Ausverkauft');
define('BUTTON_SUBMIT_ALT', 'Senden');
define('BUTTON_UNSUBSCRIBE', 'Abmelden');
define('BUTTON_UPDATE_ALT', 'Ändern');
define('BUTTON_VIEW_SMALL_ALT', 'Ansehen');
