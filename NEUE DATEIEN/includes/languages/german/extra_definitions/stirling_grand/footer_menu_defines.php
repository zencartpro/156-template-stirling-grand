...
Define('TITLE_THREE', '<h2 class="hide">Kundenservice</h2><h2 class="heading">Kundenservice</h2>');
...
Define('GOOGLE', 'https://plus.google.com/xxx/posts');
Define('BLOG', 'http://www.google.de');